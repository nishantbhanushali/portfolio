       ...
       >
        <img src={Logo} alt="logo" className="w-9 h-9 object-contain" />
         <p className="text-white text-[18px] 
           font-bold flex  ">Nishant   <span className=" sm:block hidden ml-2 "  > 
            |  Full stack development </span>  </p> 
       </Link>
...
<div className="sm:hidden flex flex-1 justify-end items-center">
  <img src={ toggle ?  close : menu}
   ...
   className="h-[30px] w-[30px] object-contain cursor-pointer "
    ...
    <div className={`${!toggle ? "hidden" : "flex"} p-6 black-gradient absolute top-20 right-0 my-4 mx-2 min-w-[140px] z-10 rounded-xl`} >
